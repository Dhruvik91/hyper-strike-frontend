...
import { WithdrawalForm } from "@/features/wallet/components/WithdrawalForm";
import { WithdrawalHistory } from "@/features/wallet/components/WithdrawalHistory";
        ...
        <div className="space-y-12 pb-20">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                <div className="lg:col-span-8 space-y-8">
                    ...
                    <WithdrawalHistory withdrawals={withdrawalHistory?.items || []} isLoading={isHistoryLoading} />
                </div>
