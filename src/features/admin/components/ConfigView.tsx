...
import { ConfigInput } from "../containers/ConfigContainer";

interface ConfigViewProps {
    form: UseFormReturn<ConfigInput>;
    onSubmit: (values: ConfigInput) => void;
    isLoading: boolean;
    isUpdating: boolean;
}

export function ConfigView({ form, onSubmit, isLoading, isUpdating }: ConfigViewProps) {
    if (isLoading) {
        return (
                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                ...
                                <div className="pt-4 border-t border-white/5">
                                    ...
                                    >
                                        {isUpdating ? "Executing Protocol..." : "Commit Changes"}
