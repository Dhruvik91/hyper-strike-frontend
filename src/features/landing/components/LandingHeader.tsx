...
export function LandingHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 h-18 md:h-20 px-4 md:px-8 flex items-center justify-between backdrop-blur-3xl bg-black/40 border-b border-white/5 z-[100]">
      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <Link href={FRONTEND_ROUTES.REGISTER}>
          <Button className="bg-gradient-primary glow-primary text-white text-[10px] md:text-xs font-black uppercase tracking-widest rounded-full px-6 md:px-8 py-2 md:py-2.5 h-auto border border-primary/50 hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(161,0,255,0.4)]">
            Sign Up
          </Button>
        </Link>
      </div>
